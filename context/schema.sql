...
CREATE TABLE atleta (
    ...
    direccion_detalle      TEXT,                          -- parroquia, sector, calle, casa/apto, habitación
    escuela_id             INTEGER REFERENCES escuela(id),
...
INSERT INTO estado (id, nombre) VALUES (1, 'Miranda');

-- Los 21 municipios del Edo. Miranda (ajustables por el administrador)
INSERT INTO municipio (estado_id, nombre) VALUES
    (1, 'Acevedo'), (1, 'Andrés Bello'), (1, 'Baruta'), (1, 'Brión'),
    (1, 'Buroz'), (1, 'Carrizal'), (1, 'Chacao'), (1, 'Cristóbal Rojas'),
    (1, 'El Hatillo'), (1, 'Guaicaipuro'), (1, 'Independencia'), (1, 'Lander'),
    (1, 'Los Salias'), (1, 'Páez'), (1, 'Paz Castillo'), (1, 'Pedro Gual'),
    (1, 'Plaza'), (1, 'Simón Bolívar'), (1, 'Sucre'), (1, 'Urdaneta'),
    (1, 'Zamora');
